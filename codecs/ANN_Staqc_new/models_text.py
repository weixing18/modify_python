...
class CodeMF:
    ...
    def build(self):
        ...
        5. Transformer
        '''
        multihead_attention = MultiHeadAttention(10)
        ...
        class_model_file = self.config['workdir'] + 'models/' + self.model_params['model_name'] + '/class_model_weights.h5'
        myloss = self.dice_loss()
